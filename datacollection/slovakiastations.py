"""
Slovakia Station Collector.

Collects all Slovak railway stations by querying the API with a grid
of latitude/longitude points covering Slovakia.
"""
import math
import time
import pandas as pd
...
def main():
    """
    Main function to collect all Slovak railway stations.
    
    Generates a grid of coordinates covering Slovakia, queries the API
    for stations in each grid point, deduplicates results, and exports
    to an Excel file.
    """
